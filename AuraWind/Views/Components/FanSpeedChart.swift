...
#if DEBUG
struct FanSpeedChart_Previews: PreviewProvider {
            ...
            VStack(spacing: 20) {
                ...
                BlurGlassCard {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        FanSpeedChart(
                            dataPoints: ChartDataPoint.fanSpeedExamples(count: 60, label: "风扇1")
                                + ChartDataPoint.fanSpeedExamples(count: 60, label: "风扇2"),
                            displayMode: .line,
                            height: 250
                        )
                    }
                ...
                BlurGlassCard {
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        FanSpeedChart(
                            dataPoints: ChartDataPoint.fanSpeedExamples(count: 60, label: "CPU风扇"),
                            displayMode: .area,
                            height: 250
                        )
                    }
